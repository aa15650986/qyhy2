...
package com.qy.game.utils.ihuyi;
...
public class IhuyiSendSms {
    private final static Logger log = LoggerFactory.getLogger(IhuyiSendSms.class);
    ...
    public static void sendMsg(int mobileCode, String mobile, String account, String password, String url) {
        ...
        String content = new StringBuffer().append("您的验证码是：").append(mobileCode).append("。请不要把验证码泄露给其他人。").toString();
...
//            System.out.println(smsid);
    ...
    public static void main(String[] args) {
        ...
        NameValuePair[] data = {//提交短信
                new NameValuePair("account", "C10629225"), //查看用户名是登录用户中心->验证码短信->产品总览->APIID
                new NameValuePair("password", "c8a307c94adb26241eaf7728aacfd8ed"),  //查看密码请登录用户中心->验证码短信->产品总览->APIKEY
                //new NameValuePair("password", util.StringUtil.MD5Encode("密码")),
                new NameValuePair("mobile", "17744602860"),
                new NameValuePair("content", content),
        };
        method.setRequestBody(data);
